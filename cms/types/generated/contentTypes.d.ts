...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'articles';
    displayName: 'Article';
    description: 'Blog articles with multilingual content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    title: Attribute.JSON & Attribute.Required;
    slug: Attribute.String & Attribute.Required & Attribute.Unique;
    subtitle: Attribute.JSON;
    date: Attribute.String;
    tags: Attribute.JSON;
    category: Attribute.String & Attribute.DefaultTo<'article'>;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'projects';
    displayName: 'Project';
    description: 'Portfolio projects with multilingual content';
  };
  options: {
    draftAndPublish: true;
  };
